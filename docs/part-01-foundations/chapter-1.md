...
<Image
  img={require('../../static/img/physical-ai-concept.svg').default}
  alt="Conceptual diagram showing Physical AI as a bridge between digital AI algorithms and physical robot hardware, including sensor inputs and actuator outputs"
  align="center"
/>
